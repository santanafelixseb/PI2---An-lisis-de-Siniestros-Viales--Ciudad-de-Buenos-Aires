...
with st.columns((1,10))[1]:
    ...
    st.markdown(ud.STR_INVISIBLE)
    st.markdown(f"Observatorio de Movilidad y Seguridad Vial, {ud.STR_INVISIBLE} 2016 - 2021")
    ...
    with st.columns((1,200))[1]:
        ...
        st.page_link("pages/04_🗺️_Lugar de Hechos.py", label="Lugar de Hechos", icon="🗺️")
